...
pub async fn get_world() -> String {
	...
	let (mut json_vallis, mut vallis) = api::get_cache::<worldstate::VallisCycle>("vallisCycle").await;
	let (mut json_cambion, mut cambion) = api::get_cache::<worldstate::CambionCycle>("cambionCycle").await;
